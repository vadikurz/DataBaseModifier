...
{
    public void ReadAndWrite(GZipStream stream, string originalFileOutputPath, string modifiedFileOutputPath,
        char delimiter)
    {
        ...
        while ((line = streamReader.ReadLine()) != null)
        {
            ...
            int.TryParse(buffer.Slice(indexOf3Delimiter + 1, indexOf4Delimiter - indexOf3Delimiter - 1),
                out LAC_TAC_NID);
            ...
            double.TryParse(buffer.Slice(indexOf6Delimiter + 1, indexOf7Delimiter - indexOf6Delimiter - 1),
                out LongitudeEW);
            ...
            double.TryParse(buffer.Slice(indexOf7Delimiter + 1, indexOf8Delimiter - indexOf7Delimiter - 1),
                out LongitudeNS);
